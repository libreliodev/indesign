The aim of the project is to develop a plug-in for Acrobat that will read and edit enhanced pdf files, according to [Librelio specifications](https://github.com/libreliodev/iOS/wiki/Enhancement).
